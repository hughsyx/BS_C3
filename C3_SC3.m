function [CAC1,CAC2,sta_use] = C3_SC3(src,rcv,lat,lon,file_name,v_src,v_rcv)
...
%         Clbrtn2 = 1;
        ...
        cc1 = CANIR_RW3(CBC_coda1,CBA_coda1,1000)*Clbrtn1;
        CAC1 = CAC1+cc1;        
        %cc2 = CANIR2(CBC_coda2,CBA_coda2,10)*Clbrtn2;  
        %cc2 = CANIR(CBC_coda2,CBA_coda2,10)*Clbrtn2; 
        cc2 = CANIR_RW3(CBC_coda2,CBA_coda2,1000)*Clbrtn2;
        CAC2 = CAC2+cc2;
