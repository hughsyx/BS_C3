function [CAC1,CAC2,CAC,sta_use] = C3_SC(src,rcv,lat,lon,file_name,v_src,v_rcv)
...
%             continue
%         end
%         if abs(dist1^2-dist2^2) < dist^2*2.5 | dist1*dist2 == 0
%             continue            
%         end
        ...
        %plot(CBA2)
        [CBA_coda1,CBA_coda2,CBC_coda1,CBC_coda2] = get_coda(CBA1,CBA2,CBC1,CBC2,dist1,dist2,npt1,vel);
       ...
       %hold on
        ...
        cc1 = CANIR_RW2(CBC_coda1,CBA_coda1,10);
        %cc1 = CANIR(CBC_coda1,CBA_coda1,10);
        CAC1 = CAC1+cc1;        
        cc2 = CANIR_RW2(CBC_coda2,CBA_coda2,10);  
        %cc2 = CANIR(CBC_coda2,CBA_coda2,10); 
        CAC2 = CAC2+cc2;
        CAC = CAC+CANIR_RW2(CBC_coda1+CBC_coda2,CBA_coda1+CBA_coda2,10);
%         
%          plot(filtfilt(b,a,CAC1(101:end-100)+CAC2(101:end-100)));
%          pause
    %end
end
calculator
