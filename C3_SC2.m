function [CAC1,CAC2,CAC,sta_use] = C3_SC2(src,rcv,lat,lon,file_name,v_src,v_rcv)
...
%         Clbrtn2 = 1;
        ...
        cc1 = CANIR_RW2(CBC_coda1,CBA_coda1,1000)*Clbrtn1;
        CAC1 = CAC1+cc1;        
        %cc2 = CANIR2(CBC_coda2,CBA_coda2,10)*Clbrtn2;  
        %cc2 = CANIR(CBC_coda2,CBA_coda2,10)*Clbrtn2; 
        cc2 = CANIR_RW2(CBC_coda2,CBA_coda2,1000)*Clbrtn2;
        CAC2 = CAC2+cc2;
        CAC = CAC+CANIR(CBC_coda1+CBC_coda2,CBA_coda1+CBA_coda2,10);
%           plot(filtfilt(b,a,cc1(101:end-100)+cc2(101:end-100)))
%           i
